...
TfLiteRegistration* Register_stdgmf_REF() {
  static TfLiteRegistration r = {stdgmf::Init, stdgmf::Free, stdgmf::Prepare,
                                 stdgmf::Eval<stdgmf::kReference>};
  return &r;
}

TfLiteRegistration* Register_stdgmf_GENERIC_OPT() {
  static TfLiteRegistration r = {stdgmf::Init, stdgmf::Free, stdgmf::Prepare,
                                 stdgmf::Eval<stdgmf::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_stdgmf_NEON_OPT() {
  static TfLiteRegistration r = {stdgmf::Init, stdgmf::Free, stdgmf::Prepare,
                                 stdgmf::Eval<stdgmf::kNeonOptimized>};
  return &r;
}

TfLiteRegistration* Register_stdgmf() {
#ifdef USE_NEON
  return Register_stdgmf_NEON_OPT();
#else
  return Register_stdgmf_GENERIC_OPT();
#endif
}
