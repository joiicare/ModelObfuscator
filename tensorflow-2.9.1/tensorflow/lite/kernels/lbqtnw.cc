...
TfLiteRegistration* Register_lbqtnw_REF() {
  static TfLiteRegistration r = {
      lbqtnw::Init, lbqtnw::Free,
      lbqtnw::SigmoidPrepare<lbqtnw::kReference>,
      lbqtnw::SigmoidEval<lbqtnw::kReference>};
  return &r;
}

TfLiteRegistration* Register_lbqtnw_GENERIC_OPT() {
  static TfLiteRegistration r = {
      lbqtnw::Init, lbqtnw::Free,
      lbqtnw::SigmoidPrepare<lbqtnw::kGenericOptimized>,
      lbqtnw::SigmoidEval<lbqtnw::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_lbqtnw() {
  ...
  // the latter one.
  return Register_lbqtnw_GENERIC_OPT();
}
