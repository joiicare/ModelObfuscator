...
TfLiteRegistration* Register_fstaei_REF() {
  static TfLiteRegistration r = {
      fstaei::Init, fstaei::Free,
      fstaei::SigmoidPrepare<fstaei::kReference>,
      fstaei::SigmoidEval<fstaei::kReference>};
  return &r;
}

TfLiteRegistration* Register_fstaei_GENERIC_OPT() {
  static TfLiteRegistration r = {
      fstaei::Init, fstaei::Free,
      fstaei::SigmoidPrepare<fstaei::kGenericOptimized>,
      fstaei::SigmoidEval<fstaei::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_fstaei() {
  ...
  // the latter one.
  return Register_fstaei_GENERIC_OPT();
}
