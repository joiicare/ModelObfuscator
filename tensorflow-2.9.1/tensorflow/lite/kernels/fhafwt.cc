...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<fhafwt::kReference, fhafwt::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_fhafwt_OPT() {
  static TfLiteRegistration r = {fhafwt::Init, fhafwt::Free,
                                 fhafwt::PrepareMeanOrSum,
                                 fhafwt::EvalMean<fhafwt::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_fhafwt_REF() {
  static TfLiteRegistration r = {fhafwt::Init, fhafwt::Free,
                                 fhafwt::PrepareMeanOrSum,
                                 fhafwt::EvalMean<fhafwt::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {fhafwt::Init, fhafwt::Free,
                                 fhafwt::PrepareMeanOrSum, fhafwt::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {fhafwt::Init, fhafwt::Free,
                                 fhafwt::PrepareProd, fhafwt::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      fhafwt::Init, fhafwt::Free, fhafwt::PrepareSimple,
      fhafwt::EvalGeneric<fhafwt::kReference, fhafwt::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      fhafwt::Init, fhafwt::Free, fhafwt::PrepareSimple,
      fhafwt::EvalGeneric<fhafwt::kReference, fhafwt::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      fhafwt::Init, fhafwt::Free, fhafwt::PrepareAllOrAny,
      fhafwt::EvalGeneric<fhafwt::kReference, fhafwt::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      fhafwt::Init, fhafwt::Free, fhafwt::PrepareAllOrAny,
      fhafwt::EvalGeneric<fhafwt::kReference, fhafwt::kAll>};
  return &r;
}

TfLiteRegistration* Register_fhafwt() {
#ifdef USE_NEON
  return Register_fhafwt_OPT();
#else
  return Register_fhafwt_REF();
#endif
}
