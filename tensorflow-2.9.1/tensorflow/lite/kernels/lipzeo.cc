...
TfLiteRegistration* Register_lipzeo_REF() {
  static TfLiteRegistration r = {lipzeo::Init, lipzeo::Free, lipzeo::Prepare,
                                 lipzeo::Eval<lipzeo::kReference>};
  return &r;
}

TfLiteRegistration* Register_lipzeo_GENERIC_OPT() {
  static TfLiteRegistration r = {lipzeo::Init, lipzeo::Free, lipzeo::Prepare,
                                 lipzeo::Eval<lipzeo::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_lipzeo_NEON_OPT() {
  static TfLiteRegistration r = {lipzeo::Init, lipzeo::Free, lipzeo::Prepare,
                                 lipzeo::Eval<lipzeo::kNeonOptimized>};
  return &r;
}

TfLiteRegistration* Register_lipzeo() {
#ifdef USE_NEON
  return Register_lipzeo_NEON_OPT();
#else
  return Register_lipzeo_GENERIC_OPT();
#endif
}
