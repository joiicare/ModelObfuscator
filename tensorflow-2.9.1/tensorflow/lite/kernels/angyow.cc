...
TfLiteRegistration* Register_angyow_REF() {
  static TfLiteRegistration r = {
      angyow::Init, angyow::Free,
      angyow::SigmoidPrepare<angyow::kReference>,
      angyow::SigmoidEval<angyow::kReference>};
  return &r;
}

TfLiteRegistration* Register_angyow_GENERIC_OPT() {
  static TfLiteRegistration r = {
      angyow::Init, angyow::Free,
      angyow::SigmoidPrepare<angyow::kGenericOptimized>,
      angyow::SigmoidEval<angyow::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_angyow() {
  ...
  // the latter one.
  return Register_angyow_GENERIC_OPT();
}
