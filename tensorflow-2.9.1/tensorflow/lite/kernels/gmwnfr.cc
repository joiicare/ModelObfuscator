...
TfLiteRegistration* Register_gmwnfr_REF() {
  static TfLiteRegistration r = {
      gmwnfr::Init, gmwnfr::Free,
      gmwnfr::SigmoidPrepare<gmwnfr::kReference>,
      gmwnfr::SigmoidEval<gmwnfr::kReference>};
  return &r;
}

TfLiteRegistration* Register_gmwnfr_GENERIC_OPT() {
  static TfLiteRegistration r = {
      gmwnfr::Init, gmwnfr::Free,
      gmwnfr::SigmoidPrepare<gmwnfr::kGenericOptimized>,
      gmwnfr::SigmoidEval<gmwnfr::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_gmwnfr() {
  ...
  // the latter one.
  return Register_gmwnfr_GENERIC_OPT();
}
