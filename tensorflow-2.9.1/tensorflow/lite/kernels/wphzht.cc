...
TfLiteRegistration* Register_wphzht_REF() {
  static TfLiteRegistration r = {
      wphzht::Init, wphzht::Free,
      wphzht::SigmoidPrepare<wphzht::kReference>,
      wphzht::SigmoidEval<wphzht::kReference>};
  return &r;
}

TfLiteRegistration* Register_wphzht_GENERIC_OPT() {
  static TfLiteRegistration r = {
      wphzht::Init, wphzht::Free,
      wphzht::SigmoidPrepare<wphzht::kGenericOptimized>,
      wphzht::SigmoidEval<wphzht::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_wphzht() {
  ...
  // the latter one.
  return Register_wphzht_GENERIC_OPT();
}
