...
TfLiteRegistration* Register_ssekhd_REF() {
  static TfLiteRegistration r = {ssekhd::Init, ssekhd::Free, ssekhd::Prepare,
                                 ssekhd::Eval<ssekhd::kReference>};
  return &r;
}

TfLiteRegistration* Register_ssekhd_GENERIC_OPT() {
  static TfLiteRegistration r = {ssekhd::Init, ssekhd::Free, ssekhd::Prepare,
                                 ssekhd::Eval<ssekhd::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_ssekhd_NEON_OPT() {
  static TfLiteRegistration r = {ssekhd::Init, ssekhd::Free, ssekhd::Prepare,
                                 ssekhd::Eval<ssekhd::kNeonOptimized>};
  return &r;
}

TfLiteRegistration* Register_ssekhd() {
#ifdef USE_NEON
  return Register_ssekhd_NEON_OPT();
#else
  return Register_ssekhd_GENERIC_OPT();
#endif
}
