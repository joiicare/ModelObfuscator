...
TfLiteRegistration* Register_yjmgmm_REF() {
  static TfLiteRegistration r = {
      yjmgmm::Init, yjmgmm::Free,
      yjmgmm::SigmoidPrepare<yjmgmm::kReference>,
      yjmgmm::SigmoidEval<yjmgmm::kReference>};
  return &r;
}

TfLiteRegistration* Register_yjmgmm_GENERIC_OPT() {
  static TfLiteRegistration r = {
      yjmgmm::Init, yjmgmm::Free,
      yjmgmm::SigmoidPrepare<yjmgmm::kGenericOptimized>,
      yjmgmm::SigmoidEval<yjmgmm::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_yjmgmm() {
  ...
  // the latter one.
  return Register_yjmgmm_GENERIC_OPT();
}
