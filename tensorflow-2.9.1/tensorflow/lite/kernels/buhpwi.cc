...
TfLiteRegistration* Register_buhpwi_REF() {
  static TfLiteRegistration r = {
      buhpwi::Init, buhpwi::Free,
      buhpwi::SigmoidPrepare<buhpwi::kReference>,
      buhpwi::SigmoidEval<buhpwi::kReference>};
  return &r;
}

TfLiteRegistration* Register_buhpwi_GENERIC_OPT() {
  static TfLiteRegistration r = {
      buhpwi::Init, buhpwi::Free,
      buhpwi::SigmoidPrepare<buhpwi::kGenericOptimized>,
      buhpwi::SigmoidEval<buhpwi::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_buhpwi() {
  ...
  // the latter one.
  return Register_buhpwi_GENERIC_OPT();
}
