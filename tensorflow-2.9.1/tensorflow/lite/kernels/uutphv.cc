...
TfLiteRegistration* Register_uutphv_REF() {
  static TfLiteRegistration r = {uutphv::Init, uutphv::Free, uutphv::Prepare,
                                 uutphv::Eval<uutphv::kReference>};
  return &r;
}

TfLiteRegistration* Register_uutphv_GENERIC_OPT() {
  static TfLiteRegistration r = {uutphv::Init, uutphv::Free, uutphv::Prepare,
                                 uutphv::Eval<uutphv::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_uutphv_NEON_OPT() {
  static TfLiteRegistration r = {uutphv::Init, uutphv::Free, uutphv::Prepare,
                                 uutphv::Eval<uutphv::kNeonOptimized>};
  return &r;
}

TfLiteRegistration* Register_uutphv() {
#ifdef USE_NEON
  return Register_uutphv_NEON_OPT();
#else
  return Register_uutphv_GENERIC_OPT();
#endif
}
