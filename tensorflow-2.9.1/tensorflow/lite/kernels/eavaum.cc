...
TfLiteRegistration* Register_eavaum_REF() {
  static TfLiteRegistration r = {
      eavaum::Init, eavaum::Free,
      eavaum::SigmoidPrepare<eavaum::kReference>,
      eavaum::SigmoidEval<eavaum::kReference>};
  return &r;
}

TfLiteRegistration* Register_eavaum_GENERIC_OPT() {
  static TfLiteRegistration r = {
      eavaum::Init, eavaum::Free,
      eavaum::SigmoidPrepare<eavaum::kGenericOptimized>,
      eavaum::SigmoidEval<eavaum::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_eavaum() {
  ...
  // the latter one.
  return Register_eavaum_GENERIC_OPT();
}
