...
TfLiteRegistration* Register_zslzah_REF() {
  static TfLiteRegistration r = {
      zslzah::Init, zslzah::Free,
      zslzah::SigmoidPrepare<zslzah::kReference>,
      zslzah::SigmoidEval<zslzah::kReference>};
  return &r;
}

TfLiteRegistration* Register_zslzah_GENERIC_OPT() {
  static TfLiteRegistration r = {
      zslzah::Init, zslzah::Free,
      zslzah::SigmoidPrepare<zslzah::kGenericOptimized>,
      zslzah::SigmoidEval<zslzah::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_zslzah() {
  ...
  // the latter one.
  return Register_zslzah_GENERIC_OPT();
}
