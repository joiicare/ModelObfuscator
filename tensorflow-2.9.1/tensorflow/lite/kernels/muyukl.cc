...
TfLiteRegistration* Register_muyukl_REF() {
  static TfLiteRegistration r = {muyukl::Init, muyukl::Free, muyukl::Prepare,
                                 muyukl::Eval<muyukl::kReference>};
  return &r;
}

TfLiteRegistration* Register_muyukl_GENERIC_OPT() {
  static TfLiteRegistration r = {muyukl::Init, muyukl::Free, muyukl::Prepare,
                                 muyukl::Eval<muyukl::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_muyukl_NEON_OPT() {
  static TfLiteRegistration r = {muyukl::Init, muyukl::Free, muyukl::Prepare,
                                 muyukl::Eval<muyukl::kNeonOptimized>};
  return &r;
}

TfLiteRegistration* Register_muyukl() {
#ifdef USE_NEON
  return Register_muyukl_NEON_OPT();
#else
  return Register_muyukl_GENERIC_OPT();
#endif
}
