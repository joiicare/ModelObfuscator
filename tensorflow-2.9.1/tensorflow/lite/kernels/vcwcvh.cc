...
TfLiteRegistration* Register_vcwcvh_REF() {
  static TfLiteRegistration r = {
      vcwcvh::Init, vcwcvh::Free,
      vcwcvh::SigmoidPrepare<vcwcvh::kReference>,
      vcwcvh::SigmoidEval<vcwcvh::kReference>};
  return &r;
}

TfLiteRegistration* Register_vcwcvh_GENERIC_OPT() {
  static TfLiteRegistration r = {
      vcwcvh::Init, vcwcvh::Free,
      vcwcvh::SigmoidPrepare<vcwcvh::kGenericOptimized>,
      vcwcvh::SigmoidEval<vcwcvh::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_vcwcvh() {
  ...
  // the latter one.
  return Register_vcwcvh_GENERIC_OPT();
}
