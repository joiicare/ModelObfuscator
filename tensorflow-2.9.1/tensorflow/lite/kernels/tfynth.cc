...
TfLiteRegistration* Register_tfynth_REF() {
  static TfLiteRegistration r = {
      tfynth::Init, tfynth::Free,
      tfynth::SigmoidPrepare<tfynth::kReference>,
      tfynth::SigmoidEval<tfynth::kReference>};
  return &r;
}

TfLiteRegistration* Register_tfynth_GENERIC_OPT() {
  static TfLiteRegistration r = {
      tfynth::Init, tfynth::Free,
      tfynth::SigmoidPrepare<tfynth::kGenericOptimized>,
      tfynth::SigmoidEval<tfynth::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_tfynth() {
  ...
  // the latter one.
  return Register_tfynth_GENERIC_OPT();
}
