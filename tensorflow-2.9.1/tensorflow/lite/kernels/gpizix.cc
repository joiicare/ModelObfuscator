...
TfLiteRegistration* Register_gpizix_REF() {
  static TfLiteRegistration r = {
      gpizix::Init, gpizix::Free,
      gpizix::SigmoidPrepare<gpizix::kReference>,
      gpizix::SigmoidEval<gpizix::kReference>};
  return &r;
}

TfLiteRegistration* Register_gpizix_GENERIC_OPT() {
  static TfLiteRegistration r = {
      gpizix::Init, gpizix::Free,
      gpizix::SigmoidPrepare<gpizix::kGenericOptimized>,
      gpizix::SigmoidEval<gpizix::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_gpizix() {
  ...
  // the latter one.
  return Register_gpizix_GENERIC_OPT();
}
