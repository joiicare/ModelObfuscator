...
TfLiteRegistration* Register_iykhsz_REF() {
  static TfLiteRegistration r = {
      iykhsz::Init, iykhsz::Free,
      iykhsz::SigmoidPrepare<iykhsz::kReference>,
      iykhsz::SigmoidEval<iykhsz::kReference>};
  return &r;
}

TfLiteRegistration* Register_iykhsz_GENERIC_OPT() {
  static TfLiteRegistration r = {
      iykhsz::Init, iykhsz::Free,
      iykhsz::SigmoidPrepare<iykhsz::kGenericOptimized>,
      iykhsz::SigmoidEval<iykhsz::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_iykhsz() {
  ...
  // the latter one.
  return Register_iykhsz_GENERIC_OPT();
}
