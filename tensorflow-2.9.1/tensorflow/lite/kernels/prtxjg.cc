...
TfLiteRegistration* Register_prtxjg_REF() {
  static TfLiteRegistration r = {
      prtxjg::Init, prtxjg::Free,
      prtxjg::SigmoidPrepare<prtxjg::kReference>,
      prtxjg::SigmoidEval<prtxjg::kReference>};
  return &r;
}

TfLiteRegistration* Register_prtxjg_GENERIC_OPT() {
  static TfLiteRegistration r = {
      prtxjg::Init, prtxjg::Free,
      prtxjg::SigmoidPrepare<prtxjg::kGenericOptimized>,
      prtxjg::SigmoidEval<prtxjg::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_prtxjg() {
  ...
  // the latter one.
  return Register_prtxjg_GENERIC_OPT();
}
