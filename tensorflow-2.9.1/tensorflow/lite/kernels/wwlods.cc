...
TfLiteRegistration* Register_wwlods_REF() {
  static TfLiteRegistration r = {
      wwlods::Init, wwlods::Free,
      wwlods::SigmoidPrepare<wwlods::kReference>,
      wwlods::SigmoidEval<wwlods::kReference>};
  return &r;
}

TfLiteRegistration* Register_wwlods_GENERIC_OPT() {
  static TfLiteRegistration r = {
      wwlods::Init, wwlods::Free,
      wwlods::SigmoidPrepare<wwlods::kGenericOptimized>,
      wwlods::SigmoidEval<wwlods::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_wwlods() {
  ...
  // the latter one.
  return Register_wwlods_GENERIC_OPT();
}
