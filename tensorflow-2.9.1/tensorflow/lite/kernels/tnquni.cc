...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<tnquni::kReference, tnquni::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_tnquni_OPT() {
  static TfLiteRegistration r = {tnquni::Init, tnquni::Free,
                                 tnquni::PrepareMeanOrSum,
                                 tnquni::EvalMean<tnquni::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_tnquni_REF() {
  static TfLiteRegistration r = {tnquni::Init, tnquni::Free,
                                 tnquni::PrepareMeanOrSum,
                                 tnquni::EvalMean<tnquni::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {tnquni::Init, tnquni::Free,
                                 tnquni::PrepareMeanOrSum, tnquni::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {tnquni::Init, tnquni::Free,
                                 tnquni::PrepareProd, tnquni::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      tnquni::Init, tnquni::Free, tnquni::PrepareSimple,
      tnquni::EvalGeneric<tnquni::kReference, tnquni::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      tnquni::Init, tnquni::Free, tnquni::PrepareSimple,
      tnquni::EvalGeneric<tnquni::kReference, tnquni::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      tnquni::Init, tnquni::Free, tnquni::PrepareAllOrAny,
      tnquni::EvalGeneric<tnquni::kReference, tnquni::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      tnquni::Init, tnquni::Free, tnquni::PrepareAllOrAny,
      tnquni::EvalGeneric<tnquni::kReference, tnquni::kAll>};
  return &r;
}

TfLiteRegistration* Register_tnquni() {
#ifdef USE_NEON
  return Register_tnquni_OPT();
#else
  return Register_tnquni_REF();
#endif
}
