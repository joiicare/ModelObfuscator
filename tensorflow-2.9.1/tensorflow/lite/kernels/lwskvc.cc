...
TfLiteRegistration* Register_lwskvc_REF() {
  static TfLiteRegistration r = {
      lwskvc::Init, lwskvc::Free,
      lwskvc::SigmoidPrepare<lwskvc::kReference>,
      lwskvc::SigmoidEval<lwskvc::kReference>};
  return &r;
}

TfLiteRegistration* Register_lwskvc_GENERIC_OPT() {
  static TfLiteRegistration r = {
      lwskvc::Init, lwskvc::Free,
      lwskvc::SigmoidPrepare<lwskvc::kGenericOptimized>,
      lwskvc::SigmoidEval<lwskvc::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_lwskvc() {
  ...
  // the latter one.
  return Register_lwskvc_GENERIC_OPT();
}
