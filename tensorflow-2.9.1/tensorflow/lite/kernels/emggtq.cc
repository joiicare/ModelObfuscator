...
TfLiteRegistration* Register_emggtq_REF() {
  static TfLiteRegistration r = {
      emggtq::Init, emggtq::Free,
      emggtq::SigmoidPrepare<emggtq::kReference>,
      emggtq::SigmoidEval<emggtq::kReference>};
  return &r;
}

TfLiteRegistration* Register_emggtq_GENERIC_OPT() {
  static TfLiteRegistration r = {
      emggtq::Init, emggtq::Free,
      emggtq::SigmoidPrepare<emggtq::kGenericOptimized>,
      emggtq::SigmoidEval<emggtq::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_emggtq() {
  ...
  // the latter one.
  return Register_emggtq_GENERIC_OPT();
}
