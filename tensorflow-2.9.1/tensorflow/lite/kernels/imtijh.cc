...
TfLiteRegistration* Register_imtijh_REF() {
  static TfLiteRegistration r = {
      imtijh::Init, imtijh::Free,
      imtijh::SigmoidPrepare<imtijh::kReference>,
      imtijh::SigmoidEval<imtijh::kReference>};
  return &r;
}

TfLiteRegistration* Register_imtijh_GENERIC_OPT() {
  static TfLiteRegistration r = {
      imtijh::Init, imtijh::Free,
      imtijh::SigmoidPrepare<imtijh::kGenericOptimized>,
      imtijh::SigmoidEval<imtijh::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_imtijh() {
  ...
  // the latter one.
  return Register_imtijh_GENERIC_OPT();
}
