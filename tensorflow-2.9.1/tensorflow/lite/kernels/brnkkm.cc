...
TfLiteRegistration* Register_brnkkm_REF() {
  static TfLiteRegistration r = {
      brnkkm::Init, brnkkm::Free,
      brnkkm::SigmoidPrepare<brnkkm::kReference>,
      brnkkm::SigmoidEval<brnkkm::kReference>};
  return &r;
}

TfLiteRegistration* Register_brnkkm_GENERIC_OPT() {
  static TfLiteRegistration r = {
      brnkkm::Init, brnkkm::Free,
      brnkkm::SigmoidPrepare<brnkkm::kGenericOptimized>,
      brnkkm::SigmoidEval<brnkkm::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_brnkkm() {
  ...
  // the latter one.
  return Register_brnkkm_GENERIC_OPT();
}
