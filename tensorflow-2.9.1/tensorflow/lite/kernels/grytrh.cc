...
TfLiteRegistration* Register_grytrh_REF() {
  static TfLiteRegistration r = {
      grytrh::Init, grytrh::Free,
      grytrh::SigmoidPrepare<grytrh::kReference>,
      grytrh::SigmoidEval<grytrh::kReference>};
  return &r;
}

TfLiteRegistration* Register_grytrh_GENERIC_OPT() {
  static TfLiteRegistration r = {
      grytrh::Init, grytrh::Free,
      grytrh::SigmoidPrepare<grytrh::kGenericOptimized>,
      grytrh::SigmoidEval<grytrh::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_grytrh() {
  ...
  // the latter one.
  return Register_grytrh_GENERIC_OPT();
}
