...
TfLiteRegistration* Register_evmzex_REF() {
  static TfLiteRegistration r = {
      evmzex::Init, evmzex::Free,
      evmzex::SigmoidPrepare<evmzex::kReference>,
      evmzex::SigmoidEval<evmzex::kReference>};
  return &r;
}

TfLiteRegistration* Register_evmzex_GENERIC_OPT() {
  static TfLiteRegistration r = {
      evmzex::Init, evmzex::Free,
      evmzex::SigmoidPrepare<evmzex::kGenericOptimized>,
      evmzex::SigmoidEval<evmzex::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_evmzex() {
  ...
  // the latter one.
  return Register_evmzex_GENERIC_OPT();
}
