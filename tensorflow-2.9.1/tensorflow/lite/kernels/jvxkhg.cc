...
TfLiteRegistration* Register_jvxkhg_REF() {
  static TfLiteRegistration r = {
      jvxkhg::Init, jvxkhg::Free,
      jvxkhg::SigmoidPrepare<jvxkhg::kReference>,
      jvxkhg::SigmoidEval<jvxkhg::kReference>};
  return &r;
}

TfLiteRegistration* Register_jvxkhg_GENERIC_OPT() {
  static TfLiteRegistration r = {
      jvxkhg::Init, jvxkhg::Free,
      jvxkhg::SigmoidPrepare<jvxkhg::kGenericOptimized>,
      jvxkhg::SigmoidEval<jvxkhg::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_jvxkhg() {
  ...
  // the latter one.
  return Register_jvxkhg_GENERIC_OPT();
}
