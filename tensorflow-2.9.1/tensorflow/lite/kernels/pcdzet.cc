...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<pcdzet::kReference, pcdzet::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_pcdzet_OPT() {
  static TfLiteRegistration r = {pcdzet::Init, pcdzet::Free,
                                 pcdzet::PrepareMeanOrSum,
                                 pcdzet::EvalMean<pcdzet::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_pcdzet_REF() {
  static TfLiteRegistration r = {pcdzet::Init, pcdzet::Free,
                                 pcdzet::PrepareMeanOrSum,
                                 pcdzet::EvalMean<pcdzet::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {pcdzet::Init, pcdzet::Free,
                                 pcdzet::PrepareMeanOrSum, pcdzet::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {pcdzet::Init, pcdzet::Free,
                                 pcdzet::PrepareProd, pcdzet::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      pcdzet::Init, pcdzet::Free, pcdzet::PrepareSimple,
      pcdzet::EvalGeneric<pcdzet::kReference, pcdzet::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      pcdzet::Init, pcdzet::Free, pcdzet::PrepareSimple,
      pcdzet::EvalGeneric<pcdzet::kReference, pcdzet::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      pcdzet::Init, pcdzet::Free, pcdzet::PrepareAllOrAny,
      pcdzet::EvalGeneric<pcdzet::kReference, pcdzet::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      pcdzet::Init, pcdzet::Free, pcdzet::PrepareAllOrAny,
      pcdzet::EvalGeneric<pcdzet::kReference, pcdzet::kAll>};
  return &r;
}

TfLiteRegistration* Register_pcdzet() {
#ifdef USE_NEON
  return Register_pcdzet_OPT();
#else
  return Register_pcdzet_REF();
#endif
}
