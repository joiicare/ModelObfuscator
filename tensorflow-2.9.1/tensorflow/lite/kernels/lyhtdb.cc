...
const bool pot_scale_int16=true;
...
TfLiteRegistration* Register_lyhtdb_REF() {
  static TfLiteRegistration r = {lyhtdb::Init, lyhtdb::Free, lyhtdb::Prepare,
                                 lyhtdb::Eval<lyhtdb::kReference>};
  return &r;
}

TfLiteRegistration* Register_lyhtdb_GENERIC_OPT() {
  static TfLiteRegistration r = {lyhtdb::Init, lyhtdb::Free, lyhtdb::Prepare,
                                 lyhtdb::Eval<lyhtdb::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_lyhtdb_NEON_OPT() {
  static TfLiteRegistration r = {lyhtdb::Init, lyhtdb::Free, lyhtdb::Prepare,
                                 lyhtdb::Eval<lyhtdb::kNeonOptimized>};
  return &r;
}

TfLiteRegistration* Register_lyhtdb() {
#ifdef USE_NEON
  return Register_lyhtdb_NEON_OPT();
#else
  return Register_lyhtdb_GENERIC_OPT();
#endif
}
