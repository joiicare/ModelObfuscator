...
TfLiteRegistration* Register_iqjdkn_REF() {
  static TfLiteRegistration r = {
      iqjdkn::Init, iqjdkn::Free,
      iqjdkn::SigmoidPrepare<iqjdkn::kReference>,
      iqjdkn::SigmoidEval<iqjdkn::kReference>};
  return &r;
}

TfLiteRegistration* Register_iqjdkn_GENERIC_OPT() {
  static TfLiteRegistration r = {
      iqjdkn::Init, iqjdkn::Free,
      iqjdkn::SigmoidPrepare<iqjdkn::kGenericOptimized>,
      iqjdkn::SigmoidEval<iqjdkn::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_iqjdkn() {
  ...
  // the latter one.
  return Register_iqjdkn_GENERIC_OPT();
}
