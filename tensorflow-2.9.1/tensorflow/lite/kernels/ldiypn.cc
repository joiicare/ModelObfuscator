...
TfLiteRegistration* Register_ldiypn_REF() {
  static TfLiteRegistration r = {
      ldiypn::Init, ldiypn::Free,
      ldiypn::SigmoidPrepare<ldiypn::kReference>,
      ldiypn::SigmoidEval<ldiypn::kReference>};
  return &r;
}

TfLiteRegistration* Register_ldiypn_GENERIC_OPT() {
  static TfLiteRegistration r = {
      ldiypn::Init, ldiypn::Free,
      ldiypn::SigmoidPrepare<ldiypn::kGenericOptimized>,
      ldiypn::SigmoidEval<ldiypn::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_ldiypn() {
  ...
  // the latter one.
  return Register_ldiypn_GENERIC_OPT();
}
