...
TfLiteRegistration* Register_fqgskd_REF() {
  static TfLiteRegistration r = {
      fqgskd::Init, fqgskd::Free,
      fqgskd::SigmoidPrepare<fqgskd::kReference>,
      fqgskd::SigmoidEval<fqgskd::kReference>};
  return &r;
}

TfLiteRegistration* Register_fqgskd_GENERIC_OPT() {
  static TfLiteRegistration r = {
      fqgskd::Init, fqgskd::Free,
      fqgskd::SigmoidPrepare<fqgskd::kGenericOptimized>,
      fqgskd::SigmoidEval<fqgskd::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_fqgskd() {
  ...
  // the latter one.
  return Register_fqgskd_GENERIC_OPT();
}
