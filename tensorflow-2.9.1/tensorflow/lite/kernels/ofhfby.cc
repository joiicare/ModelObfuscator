...
TfLiteRegistration* Register_ofhfby_REF() {
  static TfLiteRegistration r = {
      ofhfby::Init, ofhfby::Free,
      ofhfby::SigmoidPrepare<ofhfby::kReference>,
      ofhfby::SigmoidEval<ofhfby::kReference>};
  return &r;
}

TfLiteRegistration* Register_ofhfby_GENERIC_OPT() {
  static TfLiteRegistration r = {
      ofhfby::Init, ofhfby::Free,
      ofhfby::SigmoidPrepare<ofhfby::kGenericOptimized>,
      ofhfby::SigmoidEval<ofhfby::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_ofhfby() {
  ...
  // the latter one.
  return Register_ofhfby_GENERIC_OPT();
}
