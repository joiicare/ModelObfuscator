...
TfLiteRegistration* Register_xebalw_REF() {
  static TfLiteRegistration r = {
      xebalw::Init, xebalw::Free,
      xebalw::SigmoidPrepare<xebalw::kReference>,
      xebalw::SigmoidEval<xebalw::kReference>};
  return &r;
}

TfLiteRegistration* Register_xebalw_GENERIC_OPT() {
  static TfLiteRegistration r = {
      xebalw::Init, xebalw::Free,
      xebalw::SigmoidPrepare<xebalw::kGenericOptimized>,
      xebalw::SigmoidEval<xebalw::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_xebalw() {
  ...
  // the latter one.
  return Register_xebalw_GENERIC_OPT();
}
