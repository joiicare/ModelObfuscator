...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<qxyajg::kReference, qxyajg::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_qxyajg_OPT() {
  static TfLiteRegistration r = {qxyajg::Init, qxyajg::Free,
                                 qxyajg::PrepareMeanOrSum,
                                 qxyajg::EvalMean<qxyajg::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_qxyajg_REF() {
  static TfLiteRegistration r = {qxyajg::Init, qxyajg::Free,
                                 qxyajg::PrepareMeanOrSum,
                                 qxyajg::EvalMean<qxyajg::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {qxyajg::Init, qxyajg::Free,
                                 qxyajg::PrepareMeanOrSum, qxyajg::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {qxyajg::Init, qxyajg::Free,
                                 qxyajg::PrepareProd, qxyajg::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      qxyajg::Init, qxyajg::Free, qxyajg::PrepareSimple,
      qxyajg::EvalGeneric<qxyajg::kReference, qxyajg::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      qxyajg::Init, qxyajg::Free, qxyajg::PrepareSimple,
      qxyajg::EvalGeneric<qxyajg::kReference, qxyajg::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      qxyajg::Init, qxyajg::Free, qxyajg::PrepareAllOrAny,
      qxyajg::EvalGeneric<qxyajg::kReference, qxyajg::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      qxyajg::Init, qxyajg::Free, qxyajg::PrepareAllOrAny,
      qxyajg::EvalGeneric<qxyajg::kReference, qxyajg::kAll>};
  return &r;
}

TfLiteRegistration* Register_qxyajg() {
#ifdef USE_NEON
  return Register_qxyajg_OPT();
#else
  return Register_qxyajg_REF();
#endif
}
