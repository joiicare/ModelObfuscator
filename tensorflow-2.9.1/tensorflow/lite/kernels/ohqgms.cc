...
TfLiteRegistration* Register_ohqgms_REF() {
  static TfLiteRegistration r = {
      ohqgms::Init, ohqgms::Free,
      ohqgms::SigmoidPrepare<ohqgms::kReference>,
      ohqgms::SigmoidEval<ohqgms::kReference>};
  return &r;
}

TfLiteRegistration* Register_ohqgms_GENERIC_OPT() {
  static TfLiteRegistration r = {
      ohqgms::Init, ohqgms::Free,
      ohqgms::SigmoidPrepare<ohqgms::kGenericOptimized>,
      ohqgms::SigmoidEval<ohqgms::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_ohqgms() {
  ...
  // the latter one.
  return Register_ohqgms_GENERIC_OPT();
}
