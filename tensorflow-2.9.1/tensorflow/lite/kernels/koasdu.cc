...
TfLiteRegistration* Register_koasdu_REF() {
  static TfLiteRegistration r = {
      koasdu::Init, koasdu::Free,
      koasdu::SigmoidPrepare<koasdu::kReference>,
      koasdu::SigmoidEval<koasdu::kReference>};
  return &r;
}

TfLiteRegistration* Register_koasdu_GENERIC_OPT() {
  static TfLiteRegistration r = {
      koasdu::Init, koasdu::Free,
      koasdu::SigmoidPrepare<koasdu::kGenericOptimized>,
      koasdu::SigmoidEval<koasdu::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_koasdu() {
  ...
  // the latter one.
  return Register_koasdu_GENERIC_OPT();
}
