...
TfLiteRegistration* Register_ivakej_REF() {
  static TfLiteRegistration r = {
      ivakej::Init, ivakej::Free,
      ivakej::SigmoidPrepare<ivakej::kReference>,
      ivakej::SigmoidEval<ivakej::kReference>};
  return &r;
}

TfLiteRegistration* Register_ivakej_GENERIC_OPT() {
  static TfLiteRegistration r = {
      ivakej::Init, ivakej::Free,
      ivakej::SigmoidPrepare<ivakej::kGenericOptimized>,
      ivakej::SigmoidEval<ivakej::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_ivakej() {
  ...
  // the latter one.
  return Register_ivakej_GENERIC_OPT();
}
