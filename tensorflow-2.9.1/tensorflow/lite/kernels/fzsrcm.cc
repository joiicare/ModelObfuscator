...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<fzsrcm::kReference, fzsrcm::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_fzsrcm_OPT() {
  static TfLiteRegistration r = {fzsrcm::Init, fzsrcm::Free,
                                 fzsrcm::PrepareMeanOrSum,
                                 fzsrcm::EvalMean<fzsrcm::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_fzsrcm_REF() {
  static TfLiteRegistration r = {fzsrcm::Init, fzsrcm::Free,
                                 fzsrcm::PrepareMeanOrSum,
                                 fzsrcm::EvalMean<fzsrcm::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {fzsrcm::Init, fzsrcm::Free,
                                 fzsrcm::PrepareMeanOrSum, fzsrcm::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {fzsrcm::Init, fzsrcm::Free,
                                 fzsrcm::PrepareProd, fzsrcm::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      fzsrcm::Init, fzsrcm::Free, fzsrcm::PrepareSimple,
      fzsrcm::EvalGeneric<fzsrcm::kReference, fzsrcm::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      fzsrcm::Init, fzsrcm::Free, fzsrcm::PrepareSimple,
      fzsrcm::EvalGeneric<fzsrcm::kReference, fzsrcm::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      fzsrcm::Init, fzsrcm::Free, fzsrcm::PrepareAllOrAny,
      fzsrcm::EvalGeneric<fzsrcm::kReference, fzsrcm::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      fzsrcm::Init, fzsrcm::Free, fzsrcm::PrepareAllOrAny,
      fzsrcm::EvalGeneric<fzsrcm::kReference, fzsrcm::kAll>};
  return &r;
}

TfLiteRegistration* Register_fzsrcm() {
#ifdef USE_NEON
  return Register_fzsrcm_OPT();
#else
  return Register_fzsrcm_REF();
#endif
}
