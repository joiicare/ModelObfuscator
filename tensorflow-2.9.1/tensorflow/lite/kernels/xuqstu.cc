...
TfLiteRegistration* Register_xuqstu_REF() {
  static TfLiteRegistration r = {
      xuqstu::Init, xuqstu::Free,
      xuqstu::SigmoidPrepare<xuqstu::kReference>,
      xuqstu::SigmoidEval<xuqstu::kReference>};
  return &r;
}

TfLiteRegistration* Register_xuqstu_GENERIC_OPT() {
  static TfLiteRegistration r = {
      xuqstu::Init, xuqstu::Free,
      xuqstu::SigmoidPrepare<xuqstu::kGenericOptimized>,
      xuqstu::SigmoidEval<xuqstu::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_xuqstu() {
  ...
  // the latter one.
  return Register_xuqstu_GENERIC_OPT();
}
