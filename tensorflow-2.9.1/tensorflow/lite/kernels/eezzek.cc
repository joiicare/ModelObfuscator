...
TfLiteRegistration* Register_eezzek_REF() {
  static TfLiteRegistration r = {
      eezzek::Init, eezzek::Free,
      eezzek::SigmoidPrepare<eezzek::kReference>,
      eezzek::SigmoidEval<eezzek::kReference>};
  return &r;
}

TfLiteRegistration* Register_eezzek_GENERIC_OPT() {
  static TfLiteRegistration r = {
      eezzek::Init, eezzek::Free,
      eezzek::SigmoidPrepare<eezzek::kGenericOptimized>,
      eezzek::SigmoidEval<eezzek::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_eezzek() {
  ...
  // the latter one.
  return Register_eezzek_GENERIC_OPT();
}
