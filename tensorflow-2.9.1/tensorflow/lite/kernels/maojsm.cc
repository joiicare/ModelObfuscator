...
TfLiteRegistration* Register_maojsm_REF() {
  static TfLiteRegistration r = {
      maojsm::Init, maojsm::Free,
      maojsm::SigmoidPrepare<maojsm::kReference>,
      maojsm::SigmoidEval<maojsm::kReference>};
  return &r;
}

TfLiteRegistration* Register_maojsm_GENERIC_OPT() {
  static TfLiteRegistration r = {
      maojsm::Init, maojsm::Free,
      maojsm::SigmoidPrepare<maojsm::kGenericOptimized>,
      maojsm::SigmoidEval<maojsm::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_maojsm() {
  ...
  // the latter one.
  return Register_maojsm_GENERIC_OPT();
}
