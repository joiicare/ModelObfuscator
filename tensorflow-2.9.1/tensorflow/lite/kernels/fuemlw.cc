...
TfLiteRegistration* Register_fuemlw_REF() {
  static TfLiteRegistration r = {
      fuemlw::Init, fuemlw::Free,
      fuemlw::SigmoidPrepare<fuemlw::kReference>,
      fuemlw::SigmoidEval<fuemlw::kReference>};
  return &r;
}

TfLiteRegistration* Register_fuemlw_GENERIC_OPT() {
  static TfLiteRegistration r = {
      fuemlw::Init, fuemlw::Free,
      fuemlw::SigmoidPrepare<fuemlw::kGenericOptimized>,
      fuemlw::SigmoidEval<fuemlw::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_fuemlw() {
  ...
  // the latter one.
  return Register_fuemlw_GENERIC_OPT();
}
