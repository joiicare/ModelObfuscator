...
TfLiteRegistration* Register_rtioys_REF() {
  static TfLiteRegistration r = {
      rtioys::Init, rtioys::Free,
      rtioys::SigmoidPrepare<rtioys::kReference>,
      rtioys::SigmoidEval<rtioys::kReference>};
  return &r;
}

TfLiteRegistration* Register_rtioys_GENERIC_OPT() {
  static TfLiteRegistration r = {
      rtioys::Init, rtioys::Free,
      rtioys::SigmoidPrepare<rtioys::kGenericOptimized>,
      rtioys::SigmoidEval<rtioys::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_rtioys() {
  ...
  // the latter one.
  return Register_rtioys_GENERIC_OPT();
}
