...
TfLiteRegistration* Register_oanafs_REF() {
  static TfLiteRegistration r = {
      oanafs::Init, oanafs::Free,
      oanafs::SigmoidPrepare<oanafs::kReference>,
      oanafs::SigmoidEval<oanafs::kReference>};
  return &r;
}

TfLiteRegistration* Register_oanafs_GENERIC_OPT() {
  static TfLiteRegistration r = {
      oanafs::Init, oanafs::Free,
      oanafs::SigmoidPrepare<oanafs::kGenericOptimized>,
      oanafs::SigmoidEval<oanafs::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_oanafs() {
  ...
  // the latter one.
  return Register_oanafs_GENERIC_OPT();
}
