...
TfLiteRegistration* Register_nczglg_REF() {
  static TfLiteRegistration r = {
      nczglg::Init, nczglg::Free,
      nczglg::SigmoidPrepare<nczglg::kReference>,
      nczglg::SigmoidEval<nczglg::kReference>};
  return &r;
}

TfLiteRegistration* Register_nczglg_GENERIC_OPT() {
  static TfLiteRegistration r = {
      nczglg::Init, nczglg::Free,
      nczglg::SigmoidPrepare<nczglg::kGenericOptimized>,
      nczglg::SigmoidEval<nczglg::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_nczglg() {
  ...
  // the latter one.
  return Register_nczglg_GENERIC_OPT();
}
