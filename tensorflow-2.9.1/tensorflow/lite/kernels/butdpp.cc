...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<butdpp::kReference, butdpp::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_butdpp_OPT() {
  static TfLiteRegistration r = {butdpp::Init, butdpp::Free,
                                 butdpp::PrepareMeanOrSum,
                                 butdpp::EvalMean<butdpp::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_butdpp_REF() {
  static TfLiteRegistration r = {butdpp::Init, butdpp::Free,
                                 butdpp::PrepareMeanOrSum,
                                 butdpp::EvalMean<butdpp::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {butdpp::Init, butdpp::Free,
                                 butdpp::PrepareMeanOrSum, butdpp::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {butdpp::Init, butdpp::Free,
                                 butdpp::PrepareProd, butdpp::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      butdpp::Init, butdpp::Free, butdpp::PrepareSimple,
      butdpp::EvalGeneric<butdpp::kReference, butdpp::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      butdpp::Init, butdpp::Free, butdpp::PrepareSimple,
      butdpp::EvalGeneric<butdpp::kReference, butdpp::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      butdpp::Init, butdpp::Free, butdpp::PrepareAllOrAny,
      butdpp::EvalGeneric<butdpp::kReference, butdpp::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      butdpp::Init, butdpp::Free, butdpp::PrepareAllOrAny,
      butdpp::EvalGeneric<butdpp::kReference, butdpp::kAll>};
  return &r;
}

TfLiteRegistration* Register_butdpp() {
#ifdef USE_NEON
  return Register_butdpp_OPT();
#else
  return Register_butdpp_REF();
#endif
}
