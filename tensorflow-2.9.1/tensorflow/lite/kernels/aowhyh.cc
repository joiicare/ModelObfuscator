...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<aowhyh::kReference, aowhyh::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_aowhyh_OPT() {
  static TfLiteRegistration r = {aowhyh::Init, aowhyh::Free,
                                 aowhyh::PrepareMeanOrSum,
                                 aowhyh::EvalMean<aowhyh::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_aowhyh_REF() {
  static TfLiteRegistration r = {aowhyh::Init, aowhyh::Free,
                                 aowhyh::PrepareMeanOrSum,
                                 aowhyh::EvalMean<aowhyh::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {aowhyh::Init, aowhyh::Free,
                                 aowhyh::PrepareMeanOrSum, aowhyh::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {aowhyh::Init, aowhyh::Free,
                                 aowhyh::PrepareProd, aowhyh::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      aowhyh::Init, aowhyh::Free, aowhyh::PrepareSimple,
      aowhyh::EvalGeneric<aowhyh::kReference, aowhyh::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      aowhyh::Init, aowhyh::Free, aowhyh::PrepareSimple,
      aowhyh::EvalGeneric<aowhyh::kReference, aowhyh::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      aowhyh::Init, aowhyh::Free, aowhyh::PrepareAllOrAny,
      aowhyh::EvalGeneric<aowhyh::kReference, aowhyh::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      aowhyh::Init, aowhyh::Free, aowhyh::PrepareAllOrAny,
      aowhyh::EvalGeneric<aowhyh::kReference, aowhyh::kAll>};
  return &r;
}

TfLiteRegistration* Register_aowhyh() {
#ifdef USE_NEON
  return Register_aowhyh_OPT();
#else
  return Register_aowhyh_REF();
#endif
}
