...
TfLiteRegistration* Register_cbvkib_REF() {
  static TfLiteRegistration r = {
      cbvkib::Init, cbvkib::Free,
      cbvkib::SigmoidPrepare<cbvkib::kReference>,
      cbvkib::SigmoidEval<cbvkib::kReference>};
  return &r;
}

TfLiteRegistration* Register_cbvkib_GENERIC_OPT() {
  static TfLiteRegistration r = {
      cbvkib::Init, cbvkib::Free,
      cbvkib::SigmoidPrepare<cbvkib::kGenericOptimized>,
      cbvkib::SigmoidEval<cbvkib::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_cbvkib() {
  ...
  // the latter one.
  return Register_cbvkib_GENERIC_OPT();
}
