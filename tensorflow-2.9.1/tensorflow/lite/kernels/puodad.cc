...
TfLiteRegistration* Register_puodad_REF() {
  static TfLiteRegistration r = {
      puodad::Init, puodad::Free,
      puodad::SigmoidPrepare<puodad::kReference>,
      puodad::SigmoidEval<puodad::kReference>};
  return &r;
}

TfLiteRegistration* Register_puodad_GENERIC_OPT() {
  static TfLiteRegistration r = {
      puodad::Init, puodad::Free,
      puodad::SigmoidPrepare<puodad::kGenericOptimized>,
      puodad::SigmoidEval<puodad::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_puodad() {
  ...
  // the latter one.
  return Register_puodad_GENERIC_OPT();
}
