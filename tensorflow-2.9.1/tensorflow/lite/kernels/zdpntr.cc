...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<zdpntr::kReference, zdpntr::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_zdpntr_OPT() {
  static TfLiteRegistration r = {zdpntr::Init, zdpntr::Free,
                                 zdpntr::PrepareMeanOrSum,
                                 zdpntr::EvalMean<zdpntr::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_zdpntr_REF() {
  static TfLiteRegistration r = {zdpntr::Init, zdpntr::Free,
                                 zdpntr::PrepareMeanOrSum,
                                 zdpntr::EvalMean<zdpntr::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {zdpntr::Init, zdpntr::Free,
                                 zdpntr::PrepareMeanOrSum, zdpntr::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {zdpntr::Init, zdpntr::Free,
                                 zdpntr::PrepareProd, zdpntr::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      zdpntr::Init, zdpntr::Free, zdpntr::PrepareSimple,
      zdpntr::EvalGeneric<zdpntr::kReference, zdpntr::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      zdpntr::Init, zdpntr::Free, zdpntr::PrepareSimple,
      zdpntr::EvalGeneric<zdpntr::kReference, zdpntr::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      zdpntr::Init, zdpntr::Free, zdpntr::PrepareAllOrAny,
      zdpntr::EvalGeneric<zdpntr::kReference, zdpntr::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      zdpntr::Init, zdpntr::Free, zdpntr::PrepareAllOrAny,
      zdpntr::EvalGeneric<zdpntr::kReference, zdpntr::kAll>};
  return &r;
}

TfLiteRegistration* Register_zdpntr() {
#ifdef USE_NEON
  return Register_zdpntr_OPT();
#else
  return Register_zdpntr_REF();
#endif
}
