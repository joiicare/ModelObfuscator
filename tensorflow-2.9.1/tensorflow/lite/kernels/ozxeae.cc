...
TfLiteRegistration* Register_ozxeae_REF() {
  static TfLiteRegistration r = {
      ozxeae::Init, ozxeae::Free,
      ozxeae::SigmoidPrepare<ozxeae::kReference>,
      ozxeae::SigmoidEval<ozxeae::kReference>};
  return &r;
}

TfLiteRegistration* Register_ozxeae_GENERIC_OPT() {
  static TfLiteRegistration r = {
      ozxeae::Init, ozxeae::Free,
      ozxeae::SigmoidPrepare<ozxeae::kGenericOptimized>,
      ozxeae::SigmoidEval<ozxeae::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_ozxeae() {
  ...
  // the latter one.
  return Register_ozxeae_GENERIC_OPT();
}
