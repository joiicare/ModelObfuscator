...
TfLiteRegistration* Register_rhjrge_REF() {
  static TfLiteRegistration r = {
      rhjrge::Init, rhjrge::Free,
      rhjrge::SigmoidPrepare<rhjrge::kReference>,
      rhjrge::SigmoidEval<rhjrge::kReference>};
  return &r;
}

TfLiteRegistration* Register_rhjrge_GENERIC_OPT() {
  static TfLiteRegistration r = {
      rhjrge::Init, rhjrge::Free,
      rhjrge::SigmoidPrepare<rhjrge::kGenericOptimized>,
      rhjrge::SigmoidEval<rhjrge::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_rhjrge() {
  ...
  // the latter one.
  return Register_rhjrge_GENERIC_OPT();
}
