...
TfLiteRegistration* Register_eggucg_REF() {
  static TfLiteRegistration r = {
      eggucg::Init, eggucg::Free,
      eggucg::SigmoidPrepare<eggucg::kReference>,
      eggucg::SigmoidEval<eggucg::kReference>};
  return &r;
}

TfLiteRegistration* Register_eggucg_GENERIC_OPT() {
  static TfLiteRegistration r = {
      eggucg::Init, eggucg::Free,
      eggucg::SigmoidPrepare<eggucg::kGenericOptimized>,
      eggucg::SigmoidEval<eggucg::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_eggucg() {
  ...
  // the latter one.
  return Register_eggucg_GENERIC_OPT();
}
