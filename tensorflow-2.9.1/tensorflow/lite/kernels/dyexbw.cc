...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<dyexbw::kReference, dyexbw::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_dyexbw_OPT() {
  static TfLiteRegistration r = {dyexbw::Init, dyexbw::Free,
                                 dyexbw::PrepareMeanOrSum,
                                 dyexbw::EvalMean<dyexbw::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_dyexbw_REF() {
  static TfLiteRegistration r = {dyexbw::Init, dyexbw::Free,
                                 dyexbw::PrepareMeanOrSum,
                                 dyexbw::EvalMean<dyexbw::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {dyexbw::Init, dyexbw::Free,
                                 dyexbw::PrepareMeanOrSum, dyexbw::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {dyexbw::Init, dyexbw::Free,
                                 dyexbw::PrepareProd, dyexbw::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      dyexbw::Init, dyexbw::Free, dyexbw::PrepareSimple,
      dyexbw::EvalGeneric<dyexbw::kReference, dyexbw::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      dyexbw::Init, dyexbw::Free, dyexbw::PrepareSimple,
      dyexbw::EvalGeneric<dyexbw::kReference, dyexbw::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      dyexbw::Init, dyexbw::Free, dyexbw::PrepareAllOrAny,
      dyexbw::EvalGeneric<dyexbw::kReference, dyexbw::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      dyexbw::Init, dyexbw::Free, dyexbw::PrepareAllOrAny,
      dyexbw::EvalGeneric<dyexbw::kReference, dyexbw::kAll>};
  return &r;
}

TfLiteRegistration* Register_dyexbw() {
#ifdef USE_NEON
  return Register_dyexbw_OPT();
#else
  return Register_dyexbw_REF();
#endif
}
