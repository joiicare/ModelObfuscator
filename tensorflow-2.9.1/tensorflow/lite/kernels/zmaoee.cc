...
TfLiteRegistration* Register_zmaoee_REF() {
  static TfLiteRegistration r = {
      zmaoee::Init, zmaoee::Free,
      zmaoee::SigmoidPrepare<zmaoee::kReference>,
      zmaoee::SigmoidEval<zmaoee::kReference>};
  return &r;
}

TfLiteRegistration* Register_zmaoee_GENERIC_OPT() {
  static TfLiteRegistration r = {
      zmaoee::Init, zmaoee::Free,
      zmaoee::SigmoidPrepare<zmaoee::kGenericOptimized>,
      zmaoee::SigmoidEval<zmaoee::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_zmaoee() {
  ...
  // the latter one.
  return Register_zmaoee_GENERIC_OPT();
}
