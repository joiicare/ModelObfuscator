...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<sdjwjc::kReference, sdjwjc::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_sdjwjc_OPT() {
  static TfLiteRegistration r = {sdjwjc::Init, sdjwjc::Free,
                                 sdjwjc::PrepareMeanOrSum,
                                 sdjwjc::EvalMean<sdjwjc::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_sdjwjc_REF() {
  static TfLiteRegistration r = {sdjwjc::Init, sdjwjc::Free,
                                 sdjwjc::PrepareMeanOrSum,
                                 sdjwjc::EvalMean<sdjwjc::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {sdjwjc::Init, sdjwjc::Free,
                                 sdjwjc::PrepareMeanOrSum, sdjwjc::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {sdjwjc::Init, sdjwjc::Free,
                                 sdjwjc::PrepareProd, sdjwjc::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      sdjwjc::Init, sdjwjc::Free, sdjwjc::PrepareSimple,
      sdjwjc::EvalGeneric<sdjwjc::kReference, sdjwjc::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      sdjwjc::Init, sdjwjc::Free, sdjwjc::PrepareSimple,
      sdjwjc::EvalGeneric<sdjwjc::kReference, sdjwjc::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      sdjwjc::Init, sdjwjc::Free, sdjwjc::PrepareAllOrAny,
      sdjwjc::EvalGeneric<sdjwjc::kReference, sdjwjc::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      sdjwjc::Init, sdjwjc::Free, sdjwjc::PrepareAllOrAny,
      sdjwjc::EvalGeneric<sdjwjc::kReference, sdjwjc::kAll>};
  return &r;
}

TfLiteRegistration* Register_sdjwjc() {
#ifdef USE_NEON
  return Register_sdjwjc_OPT();
#else
  return Register_sdjwjc_REF();
#endif
}
