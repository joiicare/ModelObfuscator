...
TfLiteRegistration* Register_ttdwgh_REF() {
  static TfLiteRegistration r = {
      ttdwgh::Init, ttdwgh::Free,
      ttdwgh::SigmoidPrepare<ttdwgh::kReference>,
      ttdwgh::SigmoidEval<ttdwgh::kReference>};
  return &r;
}

TfLiteRegistration* Register_ttdwgh_GENERIC_OPT() {
  static TfLiteRegistration r = {
      ttdwgh::Init, ttdwgh::Free,
      ttdwgh::SigmoidPrepare<ttdwgh::kGenericOptimized>,
      ttdwgh::SigmoidEval<ttdwgh::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_ttdwgh() {
  ...
  // the latter one.
  return Register_ttdwgh_GENERIC_OPT();
}
