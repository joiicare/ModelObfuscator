...
TfLiteRegistration* Register_vkafgw_REF() {
  static TfLiteRegistration r = {
      vkafgw::Init, vkafgw::Free,
      vkafgw::SigmoidPrepare<vkafgw::kReference>,
      vkafgw::SigmoidEval<vkafgw::kReference>};
  return &r;
}

TfLiteRegistration* Register_vkafgw_GENERIC_OPT() {
  static TfLiteRegistration r = {
      vkafgw::Init, vkafgw::Free,
      vkafgw::SigmoidPrepare<vkafgw::kGenericOptimized>,
      vkafgw::SigmoidEval<vkafgw::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_vkafgw() {
  ...
  // the latter one.
  return Register_vkafgw_GENERIC_OPT();
}
