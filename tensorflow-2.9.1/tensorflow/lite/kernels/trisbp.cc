...
TfLiteRegistration* Register_trisbp_REF() {
  static TfLiteRegistration r = {
      trisbp::Init, trisbp::Free,
      trisbp::SigmoidPrepare<trisbp::kReference>,
      trisbp::SigmoidEval<trisbp::kReference>};
  return &r;
}

TfLiteRegistration* Register_trisbp_GENERIC_OPT() {
  static TfLiteRegistration r = {
      trisbp::Init, trisbp::Free,
      trisbp::SigmoidPrepare<trisbp::kGenericOptimized>,
      trisbp::SigmoidEval<trisbp::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_trisbp() {
  ...
  // the latter one.
  return Register_trisbp_GENERIC_OPT();
}
