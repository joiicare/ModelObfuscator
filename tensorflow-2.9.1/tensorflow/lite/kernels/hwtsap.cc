...
TfLiteRegistration* Register_hwtsap_REF() {
  static TfLiteRegistration r = {
      hwtsap::Init, hwtsap::Free,
      hwtsap::SigmoidPrepare<hwtsap::kReference>,
      hwtsap::SigmoidEval<hwtsap::kReference>};
  return &r;
}

TfLiteRegistration* Register_hwtsap_GENERIC_OPT() {
  static TfLiteRegistration r = {
      hwtsap::Init, hwtsap::Free,
      hwtsap::SigmoidPrepare<hwtsap::kGenericOptimized>,
      hwtsap::SigmoidEval<hwtsap::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_hwtsap() {
  ...
  // the latter one.
  return Register_hwtsap_GENERIC_OPT();
}
