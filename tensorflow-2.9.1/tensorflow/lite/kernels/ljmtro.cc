...
TfLiteRegistration* Register_ljmtro_REF() {
  static TfLiteRegistration r = {
      ljmtro::Init, ljmtro::Free,
      ljmtro::SigmoidPrepare<ljmtro::kReference>,
      ljmtro::SigmoidEval<ljmtro::kReference>};
  return &r;
}

TfLiteRegistration* Register_ljmtro_GENERIC_OPT() {
  static TfLiteRegistration r = {
      ljmtro::Init, ljmtro::Free,
      ljmtro::SigmoidPrepare<ljmtro::kGenericOptimized>,
      ljmtro::SigmoidEval<ljmtro::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_ljmtro() {
  ...
  // the latter one.
  return Register_ljmtro_GENERIC_OPT();
}
