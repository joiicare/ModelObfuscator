...
TfLiteRegistration* Register_eemblb_REF() {
  static TfLiteRegistration r = {
      eemblb::Init, eemblb::Free,
      eemblb::SigmoidPrepare<eemblb::kReference>,
      eemblb::SigmoidEval<eemblb::kReference>};
  return &r;
}

TfLiteRegistration* Register_eemblb_GENERIC_OPT() {
  static TfLiteRegistration r = {
      eemblb::Init, eemblb::Free,
      eemblb::SigmoidPrepare<eemblb::kGenericOptimized>,
      eemblb::SigmoidEval<eemblb::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_eemblb() {
  ...
  // the latter one.
  return Register_eemblb_GENERIC_OPT();
}
