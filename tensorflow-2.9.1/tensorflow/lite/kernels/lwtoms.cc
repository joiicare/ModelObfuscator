...
TfLiteRegistration* Register_lwtoms_REF() {
  static TfLiteRegistration r = {
      lwtoms::Init, lwtoms::Free,
      lwtoms::SigmoidPrepare<lwtoms::kReference>,
      lwtoms::SigmoidEval<lwtoms::kReference>};
  return &r;
}

TfLiteRegistration* Register_lwtoms_GENERIC_OPT() {
  static TfLiteRegistration r = {
      lwtoms::Init, lwtoms::Free,
      lwtoms::SigmoidPrepare<lwtoms::kGenericOptimized>,
      lwtoms::SigmoidEval<lwtoms::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_lwtoms() {
  ...
  // the latter one.
  return Register_lwtoms_GENERIC_OPT();
}
