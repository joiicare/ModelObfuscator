...
TfLiteRegistration* Register_eowpec_REF() {
  static TfLiteRegistration r = {
      eowpec::Init, eowpec::Free,
      eowpec::SigmoidPrepare<eowpec::kReference>,
      eowpec::SigmoidEval<eowpec::kReference>};
  return &r;
}

TfLiteRegistration* Register_eowpec_GENERIC_OPT() {
  static TfLiteRegistration r = {
      eowpec::Init, eowpec::Free,
      eowpec::SigmoidPrepare<eowpec::kGenericOptimized>,
      eowpec::SigmoidEval<eowpec::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_eowpec() {
  ...
  // the latter one.
  return Register_eowpec_GENERIC_OPT();
}
