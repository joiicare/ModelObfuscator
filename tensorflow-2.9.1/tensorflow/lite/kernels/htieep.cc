...
TfLiteRegistration* Register_htieep_REF() {
  static TfLiteRegistration r = {htieep::Init, htieep::Free, htieep::Prepare,
                                 htieep::Eval<htieep::kReference>};
  return &r;
}

TfLiteRegistration* Register_htieep_GENERIC_OPT() {
  static TfLiteRegistration r = {htieep::Init, htieep::Free, htieep::Prepare,
                                 htieep::Eval<htieep::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_htieep_NEON_OPT() {
  static TfLiteRegistration r = {htieep::Init, htieep::Free, htieep::Prepare,
                                 htieep::Eval<htieep::kNeonOptimized>};
  return &r;
}

TfLiteRegistration* Register_htieep() {
#ifdef USE_NEON
  return Register_htieep_NEON_OPT();
#else
  return Register_htieep_GENERIC_OPT();
#endif
}
