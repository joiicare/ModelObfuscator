...
TfLiteRegistration* Register_vnkjcc_REF() {
  static TfLiteRegistration r = {
      vnkjcc::Init, vnkjcc::Free,
      vnkjcc::SigmoidPrepare<vnkjcc::kReference>,
      vnkjcc::SigmoidEval<vnkjcc::kReference>};
  return &r;
}

TfLiteRegistration* Register_vnkjcc_GENERIC_OPT() {
  static TfLiteRegistration r = {
      vnkjcc::Init, vnkjcc::Free,
      vnkjcc::SigmoidPrepare<vnkjcc::kGenericOptimized>,
      vnkjcc::SigmoidEval<vnkjcc::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_vnkjcc() {
  ...
  // the latter one.
  return Register_vnkjcc_GENERIC_OPT();
}
