...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<qinxkp::kReference, qinxkp::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_qinxkp_OPT() {
  static TfLiteRegistration r = {qinxkp::Init, qinxkp::Free,
                                 qinxkp::PrepareMeanOrSum,
                                 qinxkp::EvalMean<qinxkp::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_qinxkp_REF() {
  static TfLiteRegistration r = {qinxkp::Init, qinxkp::Free,
                                 qinxkp::PrepareMeanOrSum,
                                 qinxkp::EvalMean<qinxkp::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {qinxkp::Init, qinxkp::Free,
                                 qinxkp::PrepareMeanOrSum, qinxkp::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {qinxkp::Init, qinxkp::Free,
                                 qinxkp::PrepareProd, qinxkp::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      qinxkp::Init, qinxkp::Free, qinxkp::PrepareSimple,
      qinxkp::EvalGeneric<qinxkp::kReference, qinxkp::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      qinxkp::Init, qinxkp::Free, qinxkp::PrepareSimple,
      qinxkp::EvalGeneric<qinxkp::kReference, qinxkp::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      qinxkp::Init, qinxkp::Free, qinxkp::PrepareAllOrAny,
      qinxkp::EvalGeneric<qinxkp::kReference, qinxkp::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      qinxkp::Init, qinxkp::Free, qinxkp::PrepareAllOrAny,
      qinxkp::EvalGeneric<qinxkp::kReference, qinxkp::kAll>};
  return &r;
}

TfLiteRegistration* Register_qinxkp() {
#ifdef USE_NEON
  return Register_qinxkp_OPT();
#else
  return Register_qinxkp_REF();
#endif
}
