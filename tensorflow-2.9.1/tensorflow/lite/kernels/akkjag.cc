...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<akkjag::kReference, akkjag::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_akkjag_OPT() {
  static TfLiteRegistration r = {akkjag::Init, akkjag::Free,
                                 akkjag::PrepareMeanOrSum,
                                 akkjag::EvalMean<akkjag::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_akkjag_REF() {
  static TfLiteRegistration r = {akkjag::Init, akkjag::Free,
                                 akkjag::PrepareMeanOrSum,
                                 akkjag::EvalMean<akkjag::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {akkjag::Init, akkjag::Free,
                                 akkjag::PrepareMeanOrSum, akkjag::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {akkjag::Init, akkjag::Free,
                                 akkjag::PrepareProd, akkjag::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      akkjag::Init, akkjag::Free, akkjag::PrepareSimple,
      akkjag::EvalGeneric<akkjag::kReference, akkjag::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      akkjag::Init, akkjag::Free, akkjag::PrepareSimple,
      akkjag::EvalGeneric<akkjag::kReference, akkjag::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      akkjag::Init, akkjag::Free, akkjag::PrepareAllOrAny,
      akkjag::EvalGeneric<akkjag::kReference, akkjag::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      akkjag::Init, akkjag::Free, akkjag::PrepareAllOrAny,
      akkjag::EvalGeneric<akkjag::kReference, akkjag::kAll>};
  return &r;
}

TfLiteRegistration* Register_akkjag() {
#ifdef USE_NEON
  return Register_akkjag_OPT();
#else
  return Register_akkjag_REF();
#endif
}
