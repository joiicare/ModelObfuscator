...
TfLiteRegistration* Register_wzuyfg_REF() {
  static TfLiteRegistration r = {
      wzuyfg::Init, wzuyfg::Free,
      wzuyfg::SigmoidPrepare<wzuyfg::kReference>,
      wzuyfg::SigmoidEval<wzuyfg::kReference>};
  return &r;
}

TfLiteRegistration* Register_wzuyfg_GENERIC_OPT() {
  static TfLiteRegistration r = {
      wzuyfg::Init, wzuyfg::Free,
      wzuyfg::SigmoidPrepare<wzuyfg::kGenericOptimized>,
      wzuyfg::SigmoidEval<wzuyfg::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_wzuyfg() {
  ...
  // the latter one.
  return Register_wzuyfg_GENERIC_OPT();
}
