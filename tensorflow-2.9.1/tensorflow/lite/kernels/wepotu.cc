...
TfLiteRegistration* Register_wepotu_REF() {
  static TfLiteRegistration r = {wepotu::Init, wepotu::Free, wepotu::Prepare,
                                 wepotu::Eval<wepotu::kReference>};
  return &r;
}

TfLiteRegistration* Register_wepotu_GENERIC_OPT() {
  static TfLiteRegistration r = {wepotu::Init, wepotu::Free, wepotu::Prepare,
                                 wepotu::Eval<wepotu::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_wepotu_NEON_OPT() {
  static TfLiteRegistration r = {wepotu::Init, wepotu::Free, wepotu::Prepare,
                                 wepotu::Eval<wepotu::kNeonOptimized>};
  return &r;
}

TfLiteRegistration* Register_wepotu() {
#ifdef USE_NEON
  return Register_wepotu_NEON_OPT();
#else
  return Register_wepotu_GENERIC_OPT();
#endif
}
