...
TfLiteRegistration* Register_aravpo_REF() {
  static TfLiteRegistration r = {
      aravpo::Init, aravpo::Free,
      aravpo::SigmoidPrepare<aravpo::kReference>,
      aravpo::SigmoidEval<aravpo::kReference>};
  return &r;
}

TfLiteRegistration* Register_aravpo_GENERIC_OPT() {
  static TfLiteRegistration r = {
      aravpo::Init, aravpo::Free,
      aravpo::SigmoidPrepare<aravpo::kGenericOptimized>,
      aravpo::SigmoidEval<aravpo::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_aravpo() {
  ...
  // the latter one.
  return Register_aravpo_GENERIC_OPT();
}
