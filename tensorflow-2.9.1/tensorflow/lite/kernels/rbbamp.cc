...
TfLiteRegistration* Register_rbbamp_REF() {
  static TfLiteRegistration r = {rbbamp::Init, rbbamp::Free, rbbamp::Prepare,
                                 rbbamp::Eval<rbbamp::kReference>};
  return &r;
}

TfLiteRegistration* Register_rbbamp_GENERIC_OPT() {
  static TfLiteRegistration r = {rbbamp::Init, rbbamp::Free, rbbamp::Prepare,
                                 rbbamp::Eval<rbbamp::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_rbbamp_NEON_OPT() {
  static TfLiteRegistration r = {rbbamp::Init, rbbamp::Free, rbbamp::Prepare,
                                 rbbamp::Eval<rbbamp::kNeonOptimized>};
  return &r;
}

TfLiteRegistration* Register_rbbamp() {
#ifdef USE_NEON
  return Register_rbbamp_NEON_OPT();
#else
  return Register_rbbamp_GENERIC_OPT();
#endif
}
