...
TfLiteRegistration* Register_ympdfn_REF() {
  static TfLiteRegistration r = {
      ympdfn::Init, ympdfn::Free,
      ympdfn::SigmoidPrepare<ympdfn::kReference>,
      ympdfn::SigmoidEval<ympdfn::kReference>};
  return &r;
}

TfLiteRegistration* Register_ympdfn_GENERIC_OPT() {
  static TfLiteRegistration r = {
      ympdfn::Init, ympdfn::Free,
      ympdfn::SigmoidPrepare<ympdfn::kGenericOptimized>,
      ympdfn::SigmoidEval<ympdfn::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_ympdfn() {
  ...
  // the latter one.
  return Register_ympdfn_GENERIC_OPT();
}
