...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<sbxcdc::kReference, sbxcdc::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_sbxcdc_OPT() {
  static TfLiteRegistration r = {sbxcdc::Init, sbxcdc::Free,
                                 sbxcdc::PrepareMeanOrSum,
                                 sbxcdc::EvalMean<sbxcdc::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_sbxcdc_REF() {
  static TfLiteRegistration r = {sbxcdc::Init, sbxcdc::Free,
                                 sbxcdc::PrepareMeanOrSum,
                                 sbxcdc::EvalMean<sbxcdc::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {sbxcdc::Init, sbxcdc::Free,
                                 sbxcdc::PrepareMeanOrSum, sbxcdc::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {sbxcdc::Init, sbxcdc::Free,
                                 sbxcdc::PrepareProd, sbxcdc::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      sbxcdc::Init, sbxcdc::Free, sbxcdc::PrepareSimple,
      sbxcdc::EvalGeneric<sbxcdc::kReference, sbxcdc::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      sbxcdc::Init, sbxcdc::Free, sbxcdc::PrepareSimple,
      sbxcdc::EvalGeneric<sbxcdc::kReference, sbxcdc::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      sbxcdc::Init, sbxcdc::Free, sbxcdc::PrepareAllOrAny,
      sbxcdc::EvalGeneric<sbxcdc::kReference, sbxcdc::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      sbxcdc::Init, sbxcdc::Free, sbxcdc::PrepareAllOrAny,
      sbxcdc::EvalGeneric<sbxcdc::kReference, sbxcdc::kAll>};
  return &r;
}

TfLiteRegistration* Register_sbxcdc() {
#ifdef USE_NEON
  return Register_sbxcdc_OPT();
#else
  return Register_sbxcdc_REF();
#endif
}
