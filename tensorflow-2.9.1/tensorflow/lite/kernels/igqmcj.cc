...
TfLiteRegistration* Register_igqmcj_REF() {
  static TfLiteRegistration r = {
      igqmcj::Init, igqmcj::Free,
      igqmcj::SigmoidPrepare<igqmcj::kReference>,
      igqmcj::SigmoidEval<igqmcj::kReference>};
  return &r;
}

TfLiteRegistration* Register_igqmcj_GENERIC_OPT() {
  static TfLiteRegistration r = {
      igqmcj::Init, igqmcj::Free,
      igqmcj::SigmoidPrepare<igqmcj::kGenericOptimized>,
      igqmcj::SigmoidEval<igqmcj::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_igqmcj() {
  ...
  // the latter one.
  return Register_igqmcj_GENERIC_OPT();
}
