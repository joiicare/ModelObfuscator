...
TfLiteRegistration* Register_gsiwdn_REF() {
  static TfLiteRegistration r = {
      gsiwdn::Init, gsiwdn::Free,
      gsiwdn::SigmoidPrepare<gsiwdn::kReference>,
      gsiwdn::SigmoidEval<gsiwdn::kReference>};
  return &r;
}

TfLiteRegistration* Register_gsiwdn_GENERIC_OPT() {
  static TfLiteRegistration r = {
      gsiwdn::Init, gsiwdn::Free,
      gsiwdn::SigmoidPrepare<gsiwdn::kGenericOptimized>,
      gsiwdn::SigmoidEval<gsiwdn::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_gsiwdn() {
  ...
  // the latter one.
  return Register_gsiwdn_GENERIC_OPT();
}
