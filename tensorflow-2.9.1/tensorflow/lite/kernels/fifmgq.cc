...
TfLiteRegistration* Register_fifmgq_REF() {
  static TfLiteRegistration r = {
      fifmgq::Init, fifmgq::Free,
      fifmgq::SigmoidPrepare<fifmgq::kReference>,
      fifmgq::SigmoidEval<fifmgq::kReference>};
  return &r;
}

TfLiteRegistration* Register_fifmgq_GENERIC_OPT() {
  static TfLiteRegistration r = {
      fifmgq::Init, fifmgq::Free,
      fifmgq::SigmoidPrepare<fifmgq::kGenericOptimized>,
      fifmgq::SigmoidEval<fifmgq::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_fifmgq() {
  ...
  // the latter one.
  return Register_fifmgq_GENERIC_OPT();
}
