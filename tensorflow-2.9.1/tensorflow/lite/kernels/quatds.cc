...
TfLiteRegistration* Register_quatds_REF() {
  static TfLiteRegistration r = {
      quatds::Init, quatds::Free,
      quatds::SigmoidPrepare<quatds::kReference>,
      quatds::SigmoidEval<quatds::kReference>};
  return &r;
}

TfLiteRegistration* Register_quatds_GENERIC_OPT() {
  static TfLiteRegistration r = {
      quatds::Init, quatds::Free,
      quatds::SigmoidPrepare<quatds::kGenericOptimized>,
      quatds::SigmoidEval<quatds::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_quatds() {
  ...
  // the latter one.
  return Register_quatds_GENERIC_OPT();
}
