...
TfLiteRegistration* Register_nqfitl_REF() {
  static TfLiteRegistration r = {
      nqfitl::Init, nqfitl::Free,
      nqfitl::SigmoidPrepare<nqfitl::kReference>,
      nqfitl::SigmoidEval<nqfitl::kReference>};
  return &r;
}

TfLiteRegistration* Register_nqfitl_GENERIC_OPT() {
  static TfLiteRegistration r = {
      nqfitl::Init, nqfitl::Free,
      nqfitl::SigmoidPrepare<nqfitl::kGenericOptimized>,
      nqfitl::SigmoidEval<nqfitl::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_nqfitl() {
  ...
  // the latter one.
  return Register_nqfitl_GENERIC_OPT();
}
