...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<zdeccx::kReference, zdeccx::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_zdeccx_OPT() {
  static TfLiteRegistration r = {zdeccx::Init, zdeccx::Free,
                                 zdeccx::PrepareMeanOrSum,
                                 zdeccx::EvalMean<zdeccx::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_zdeccx_REF() {
  static TfLiteRegistration r = {zdeccx::Init, zdeccx::Free,
                                 zdeccx::PrepareMeanOrSum,
                                 zdeccx::EvalMean<zdeccx::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {zdeccx::Init, zdeccx::Free,
                                 zdeccx::PrepareMeanOrSum, zdeccx::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {zdeccx::Init, zdeccx::Free,
                                 zdeccx::PrepareProd, zdeccx::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      zdeccx::Init, zdeccx::Free, zdeccx::PrepareSimple,
      zdeccx::EvalGeneric<zdeccx::kReference, zdeccx::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      zdeccx::Init, zdeccx::Free, zdeccx::PrepareSimple,
      zdeccx::EvalGeneric<zdeccx::kReference, zdeccx::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      zdeccx::Init, zdeccx::Free, zdeccx::PrepareAllOrAny,
      zdeccx::EvalGeneric<zdeccx::kReference, zdeccx::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      zdeccx::Init, zdeccx::Free, zdeccx::PrepareAllOrAny,
      zdeccx::EvalGeneric<zdeccx::kReference, zdeccx::kAll>};
  return &r;
}

TfLiteRegistration* Register_zdeccx() {
#ifdef USE_NEON
  return Register_zdeccx_OPT();
#else
  return Register_zdeccx_REF();
#endif
}
