...
TfLiteRegistration* Register_mzwzbl_REF() {
  static TfLiteRegistration r = {
      mzwzbl::Init, mzwzbl::Free,
      mzwzbl::SigmoidPrepare<mzwzbl::kReference>,
      mzwzbl::SigmoidEval<mzwzbl::kReference>};
  return &r;
}

TfLiteRegistration* Register_mzwzbl_GENERIC_OPT() {
  static TfLiteRegistration r = {
      mzwzbl::Init, mzwzbl::Free,
      mzwzbl::SigmoidPrepare<mzwzbl::kGenericOptimized>,
      mzwzbl::SigmoidEval<mzwzbl::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_mzwzbl() {
  ...
  // the latter one.
  return Register_mzwzbl_GENERIC_OPT();
}
