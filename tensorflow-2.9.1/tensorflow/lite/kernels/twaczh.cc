...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<twaczh::kReference, twaczh::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_twaczh_OPT() {
  static TfLiteRegistration r = {twaczh::Init, twaczh::Free,
                                 twaczh::PrepareMeanOrSum,
                                 twaczh::EvalMean<twaczh::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_twaczh_REF() {
  static TfLiteRegistration r = {twaczh::Init, twaczh::Free,
                                 twaczh::PrepareMeanOrSum,
                                 twaczh::EvalMean<twaczh::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {twaczh::Init, twaczh::Free,
                                 twaczh::PrepareMeanOrSum, twaczh::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {twaczh::Init, twaczh::Free,
                                 twaczh::PrepareProd, twaczh::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      twaczh::Init, twaczh::Free, twaczh::PrepareSimple,
      twaczh::EvalGeneric<twaczh::kReference, twaczh::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      twaczh::Init, twaczh::Free, twaczh::PrepareSimple,
      twaczh::EvalGeneric<twaczh::kReference, twaczh::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      twaczh::Init, twaczh::Free, twaczh::PrepareAllOrAny,
      twaczh::EvalGeneric<twaczh::kReference, twaczh::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      twaczh::Init, twaczh::Free, twaczh::PrepareAllOrAny,
      twaczh::EvalGeneric<twaczh::kReference, twaczh::kAll>};
  return &r;
}

TfLiteRegistration* Register_twaczh() {
#ifdef USE_NEON
  return Register_twaczh_OPT();
#else
  return Register_twaczh_REF();
#endif
}
