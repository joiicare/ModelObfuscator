...
TfLiteRegistration* Register_oyiouw_REF() {
  static TfLiteRegistration r = {
      oyiouw::Init, oyiouw::Free,
      oyiouw::SigmoidPrepare<oyiouw::kReference>,
      oyiouw::SigmoidEval<oyiouw::kReference>};
  return &r;
}

TfLiteRegistration* Register_oyiouw_GENERIC_OPT() {
  static TfLiteRegistration r = {
      oyiouw::Init, oyiouw::Free,
      oyiouw::SigmoidPrepare<oyiouw::kGenericOptimized>,
      oyiouw::SigmoidEval<oyiouw::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_oyiouw() {
  ...
  // the latter one.
  return Register_oyiouw_GENERIC_OPT();
}
