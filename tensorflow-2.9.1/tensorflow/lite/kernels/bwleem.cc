...
TfLiteRegistration* Register_bwleem_REF() {
  static TfLiteRegistration r = {
      bwleem::Init, bwleem::Free,
      bwleem::SigmoidPrepare<bwleem::kReference>,
      bwleem::SigmoidEval<bwleem::kReference>};
  return &r;
}

TfLiteRegistration* Register_bwleem_GENERIC_OPT() {
  static TfLiteRegistration r = {
      bwleem::Init, bwleem::Free,
      bwleem::SigmoidPrepare<bwleem::kGenericOptimized>,
      bwleem::SigmoidEval<bwleem::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_bwleem() {
  ...
  // the latter one.
  return Register_bwleem_GENERIC_OPT();
}
