...
TfLiteRegistration* Register_qfktgb_REF() {
  static TfLiteRegistration r = {
      qfktgb::Init, qfktgb::Free,
      qfktgb::SigmoidPrepare<qfktgb::kReference>,
      qfktgb::SigmoidEval<qfktgb::kReference>};
  return &r;
}

TfLiteRegistration* Register_qfktgb_GENERIC_OPT() {
  static TfLiteRegistration r = {
      qfktgb::Init, qfktgb::Free,
      qfktgb::SigmoidPrepare<qfktgb::kGenericOptimized>,
      qfktgb::SigmoidEval<qfktgb::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_qfktgb() {
  ...
  // the latter one.
  return Register_qfktgb_GENERIC_OPT();
}
