...
TfLiteRegistration* Register_touvdv_REF() {
  static TfLiteRegistration r = {
      touvdv::Init, touvdv::Free,
      touvdv::SigmoidPrepare<touvdv::kReference>,
      touvdv::SigmoidEval<touvdv::kReference>};
  return &r;
}

TfLiteRegistration* Register_touvdv_GENERIC_OPT() {
  static TfLiteRegistration r = {
      touvdv::Init, touvdv::Free,
      touvdv::SigmoidPrepare<touvdv::kGenericOptimized>,
      touvdv::SigmoidEval<touvdv::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_touvdv() {
  ...
  // the latter one.
  return Register_touvdv_GENERIC_OPT();
}
