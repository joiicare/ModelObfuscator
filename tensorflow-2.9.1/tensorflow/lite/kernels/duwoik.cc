...
TfLiteStatus EvalProd(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (op_context.input->quantization.type != kTfLiteNoQuantization) {
    ...
    return EvalGeneric<duwoik::kReference, duwoik::kProd>(context, node);
  }
}

}  // namespace reduce

TfLiteRegistration* Register_duwoik_OPT() {
  static TfLiteRegistration r = {duwoik::Init, duwoik::Free,
                                 duwoik::PrepareMeanOrSum,
                                 duwoik::EvalMean<duwoik::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_duwoik_REF() {
  static TfLiteRegistration r = {duwoik::Init, duwoik::Free,
                                 duwoik::PrepareMeanOrSum,
                                 duwoik::EvalMean<duwoik::kReference>};
  return &r;
}

TfLiteRegistration* Register_SUM_REF() {
  static TfLiteRegistration r = {duwoik::Init, duwoik::Free,
                                 duwoik::PrepareMeanOrSum, duwoik::EvalSum};
  return &r;
}

TfLiteRegistration* Register_REDUCE_PROD_REF() {
  static TfLiteRegistration r = {duwoik::Init, duwoik::Free,
                                 duwoik::PrepareProd, duwoik::EvalProd};
  return &r;
}

TfLiteRegistration* Register_REDUCE_MAX_REF() {
  static TfLiteRegistration r = {
      duwoik::Init, duwoik::Free, duwoik::PrepareSimple,
      duwoik::EvalGeneric<duwoik::kReference, duwoik::kMax>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_MIN_REF() {
  static TfLiteRegistration r = {
      duwoik::Init, duwoik::Free, duwoik::PrepareSimple,
      duwoik::EvalGeneric<duwoik::kReference, duwoik::kMin>};
  return &r;
}

TfLiteRegistration* Register_REDUCE_ANY_REF() {
  static TfLiteRegistration r = {
      duwoik::Init, duwoik::Free, duwoik::PrepareAllOrAny,
      duwoik::EvalGeneric<duwoik::kReference, duwoik::kAny>};
  return &r;
}
...
TfLiteRegistration* Register_REDUCE_ALL_REF() {
  static TfLiteRegistration r = {
      duwoik::Init, duwoik::Free, duwoik::PrepareAllOrAny,
      duwoik::EvalGeneric<duwoik::kReference, duwoik::kAll>};
  return &r;
}

TfLiteRegistration* Register_duwoik() {
#ifdef USE_NEON
  return Register_duwoik_OPT();
#else
  return Register_duwoik_REF();
#endif
}
